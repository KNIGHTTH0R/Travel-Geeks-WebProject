...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 28, 2018 at 04:16 PM
...
INSERT INTO `tourist_spot` (`spot_id`, `name`, `type`, `type id`, `description`, `address`, `pref_season_id`, `imageloc`, `country_id`) VALUES
(1, 'Puran Dhaka', 'Architecture ', 1, 'bla bla bla', 'puran dhaka', 2, 'images/purandhaka.jpg', 1),
(2, 'Louvre Museum', 'Architecture', 1, 'Museum of Art', 'Paris', 0, 'images/louvre.jpg', 2),
(3, 'Coxs Bazar', 'Natural', 2, 'Largest sea beach in the world', 'Bangladesh', 1, 'images/cox.jpg', 1),
(4, 'Pantheon', 'Religious', 3, 'Old Roman Temple currently a church.', 'Rome,Italy', 2, 'images/pantheon.jpg', 3);
...
ALTER TABLE `tourist_spot`
  ...
  ADD KEY `tourist_spot_to_country_table_id_constraint` (`country_id`);
...
--
ALTER TABLE `tourist_spot`
  ADD CONSTRAINT `tourist_spot_to_country_table_id_constraint` FOREIGN KEY (`country_id`) REFERENCES `country` (`country_id`);
COMMIT;
